<?php
  ...
  //session_start(); /**la falta de esto provoco que el sistema no reconociera $_SESSION**/
...
<html>
<head>
  <title>Think Smart Ventas</title>
        ...
        <div class="navbar-header">
          <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#navbar" aria-expanded="false" aria-controls="navbar">
            ...
            <span class="icon-bar"></span>
	          ...
	          <a class="navbar-brand" href="inicio.php"><img class="img-responsive logo img-thumbnail" src="../img/logo_fav.png" alt="" width="130px" height="130px" ></a><!--era 150px-->
        </div>
